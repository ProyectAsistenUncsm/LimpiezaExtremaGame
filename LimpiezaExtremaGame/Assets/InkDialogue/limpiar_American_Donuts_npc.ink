=== LimpiarAmericanDonutsStart ===
{ LimpiarAmericanDonutsQuestState :
...
= canStart
Puedes recolectar la basura de American Donuts y traermela?
* [Si]
    ~ StartQuest("LimpiarAmericanDonutsQuest")
    Excelente!
* [No]
...
* [Dar basura]
    ~ FinishQuest("LimpiarAmericanDonutsQuest")

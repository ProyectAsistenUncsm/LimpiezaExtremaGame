=== LimpiarFoodcourtStart ===
{ LimpiarFoodcourtQuestState :
...
= canStart
Puedes recolectar la basura del Foodcourt y traermela?
* [Si]
    ~ StartQuest("LimpiarFoodcourtQuest")
    Excelente!
* [No]
...
* [Dar basura]
    ~ FinishQuest("LimpiarFoodcourtQuest")

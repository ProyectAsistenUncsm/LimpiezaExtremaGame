...
public class Quest
{
    ...
    private GameObject GetCurrentQuestStepPrefab()
    {
        ...
        {
            Debug.LogWarning("Se intento obtener quest step prefab, pero stepIndex estuvo fuera de rango indicando que no hay un step actual: QuestId=" + info.id + ", stepIndex=" + currentQuestStepIndex);
        }
    ...
    public void StoreQuestStepState(QuestStepState questStepState, int stepIndex)
    {
        ...
        {
            Debug.LogWarning("Tried to acess quest step data, but stepIndex was out of range: "
